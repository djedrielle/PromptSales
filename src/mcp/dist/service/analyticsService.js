...
export async function getSalesData(args) {
    const query = `
        SELECT 
            c.CampaignCode,
            c.CampaignName as CampaignName,
...
export async function getCampaignReach(args) {
    const query = `
        SELECT 
            c.CampaignCode,
            c.CampaignName as CampaignName,
...
export async function getCampaignChannels(args) {
    const query = `
        SELECT 
            c.CampaignCode,
            c.CampaignName as CampaignName,
...
export async function getCampaignLocations(args) {
    const query = `
        SELECT 
            c.CampaignCode,
            c.CampaignName as CampaignName,
