...
import BulkLoad, { type Options as BulkLoadOptions, type Callback as BulkLoadCallback } from 'tedious/lib/bulk-load';
import Debug from 'tedious/lib/debug';
import { EventEmitter } from 'events';
import { TransientErrorLookup } from 'tedious/lib/transient-error-lookup';
import PreloginPayload from 'tedious/lib/prelogin-payload';
import Request from 'tedious/lib/request';
import MessageIO from 'tedious/lib/message-io';
import { Parser as TokenStreamParser } from 'tedious/lib/token/token-stream-parser';
import { ISOLATION_LEVEL } from 'tedious/lib/transaction';
import { ConnectionError } from 'tedious/lib/errors';
import Message from 'tedious/lib/message';
import { type Metadata } from 'tedious/lib/metadata-parser';
import { ColumnEncryptionAzureKeyVaultProvider } from 'tedious/lib/always-encrypted/keystore-provider-azure-key-vault';
import { Collation } from 'tedious/lib/collation';
import { TokenHandler } from 'tedious/lib/token/handler';
...
declare class Connection extends EventEmitter {
     ...
     */
    on(event: 'errorMessage', listener: (message: import('tedious/lib/token/token').ErrorMessageToken) => void): this;
    /**
     ...
     */
    on(event: 'infoMessage', listener: (message: import('tedious/lib/token/token').InfoMessageToken) => void): this;
    /**
     ...
     * @private
     */
    emit(event: 'errorMessage', message: import('tedious/lib/token/token').ErrorMessageToken): boolean;
    /**
     * @private
     */
     ...
     * @private
     */
    emit(event: 'infoMessage', message: import('tedious/lib/token/token').InfoMessageToken): boolean;
    /**
     * @private
     */
